...
root.title("Dadar and Nagar Diu")
...
def open():
    ...
    top.geometry("1440x1440")
    top.iconbitmap(r'virus.ico')
    os.system('python dadragraph.py')
    top.destroy()
...
def open():
    ...
    top.geometry("1440x1440")
    top.iconbitmap(r'virus.ico')
    os.system('python dadrahospital.py')
    top.destroy()
...
def open():
    ...
    top.geometry("1440x1440")
    top.iconbitmap(r'virus.ico')
    os.system('python dadralinks.py')
    top.destroy()
