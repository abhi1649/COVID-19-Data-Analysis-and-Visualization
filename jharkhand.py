...
def open():
    ...
    os.system('python jharkhandst.py')
    top.destroy()
...
def open():
    ...
    top.geometry("1440x1440")
    top.iconbitmap(r'virus.ico')
    os.system('python jharkhandgraph.py')
    top.destroy()
...
def open():
    ...
    top.geometry("1440x1440")
    top.iconbitmap(r'virus.ico')
    os.system('python jharkhandhospital.py')
    top.destroy()
...
def open():
    ...
    top.geometry("1440x1440")
    top.iconbitmap(r'virus.ico')
    os.system('python jharkhandlinks.py')
    top.destroy()
