...
def open():
    ...
    os.system('python meghalayast.py')
    top.destroy()
...
def open():
    ...
    top.geometry("1440x1440")
    top.iconbitmap(r'virus.ico')
    os.system('python meghalayagraph.py')
    top.destroy()
...
def open():
    ...
    top.geometry("1440x1440")
    top.iconbitmap(r'virus.ico')
    os.system('python meghalayahospital.py')
    top.destroy()
...
def open():
    ...
    top.geometry("1440x1440")
    top.iconbitmap(r'virus.ico')
    os.system('python meghalayalinks.py')
    top.destroy()
