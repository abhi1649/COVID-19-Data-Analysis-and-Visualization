...
def open():
    ...
    os.system('python maharashtrast.py')
    top.destroy()
...
def open():
    ...
    top.geometry("1440x1440")
    top.iconbitmap(r'virus.ico')
    os.system('python maharashtragraph.py')
    top.destroy()
...
def open():
    ...
    top.geometry("1440x1440")
    top.iconbitmap(r'virus.ico')
    os.system('python maharashtrahospital.py')
    top.destroy()
...
def open():
    ...
    top.geometry("1440x1440")
    top.iconbitmap(r'virus.ico')
    os.system('python maharashtralinks.py')
    top.destroy()
