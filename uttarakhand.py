...
def open():
    ...
    os.system('python uttarakhandst.py')
    top.destroy()
...
def open():
    ...
    top.geometry("1440x1440")
    top.iconbitmap(r'virus.ico')
    os.system('python uttarakhandgraph.py')
    top.destroy()
...
def open():
    ...
    top.geometry("1440x1440")
    top.iconbitmap(r'virus.ico')
    os.system('python uttarakhandhospital.py')
    top.destroy()
...
def open():
    ...
    top.geometry("1440x1440")
    top.iconbitmap(r'virus.ico')
    os.system('python uttarakhandlinks.py')
    top.destroy()
